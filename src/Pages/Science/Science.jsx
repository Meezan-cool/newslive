...
const Science = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get('https://newsapi.org/v2/top-headlines?country=in&category=science&apiKey=c07892fc401b4060b4d3f0328e4b4786');
 ...
 <h1>Top <span>Science</span> <span>HeadLines</span> </h1>
