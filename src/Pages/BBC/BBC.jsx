...
const Technology = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get('https://newsapi.org/v2/top-headlines?sources=bbc-news&apiKey=c07892fc401b4060b4d3f0328e4b4786');
  ...
  return (
    <div className='businessContainer'>
     <h1>Top <span>BBC</span> <span>HeadLines</span> </h1>
