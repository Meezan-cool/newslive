...
const Entertainment = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get('https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=c07892fc401b4060b4d3f0328e4b4786');
  ...
  return (
    <div className='businessContainer'>
      <h1>Top <span>Entertainment</span> <span>HeadLines</span> </h1>
